...
class Utilities(commands.Cog):    
    ...
    async def timeout(self, ctx, member: discord.Member=None):
        ...
        try:
            ...
            await ctx.send(f'<@{member.id}> I tried to DM this to you, but your DMs are closed! You\'ll be timed out in 10 seconds.', embed=embed)
        ...
        try:
            ...
            await ctx.send(f'<@{member.id}> I tried to DM this to you, but your DMs are closed!', embed=embed)
            await member.remove_roles(role)
